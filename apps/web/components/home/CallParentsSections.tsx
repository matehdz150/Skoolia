	...
	return (
		<section aria-label="Invitación para padres" className="w-full">
			<div className="max-w-6xl mx-auto px-8">
				<div className="rounded-4xl bg-gradient-to-br from-indigo-900 via-indigo-950 to-slate-900 text-white shadow-xl overflow-hidden">
					<div className="px-10 sm:px-16 py-16 sm:py-24 text-center flex flex-col items-center">
						<h2 className="text-3xl sm:text-5xl font-extrabold tracking-tight leading-tight">
							...
							<span className="block text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-violet-400 mt-2">hoy mismo.</span>
						</h2>
