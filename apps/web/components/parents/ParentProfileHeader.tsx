      ...
      <div className="rounded-4xl bg-white p-6 shadow-sm ring-1 ring-black/5">
        <div className="flex items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            <div className="h-20 w-20 overflow-hidden rounded-full ring-4 ring-indigo-100">
          ...
          <button className="inline-flex items-center gap-2 rounded-2xl bg-slate-900 px-4 py-2 font-bold text-white shadow hover:bg-indigo-700">
