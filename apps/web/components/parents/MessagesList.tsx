  ...
  return (
    <section className="w-full rounded-4xl bg-white p-0 shadow-sm ring-1 ring-black/5 overflow-hidden">
      ...
      <div className="divide-y divide-slate-100">
        {items.map((it) => (
          <div key={it.id} className="flex items-center justify-between px-5 sm:px-6 py-4 sm:py-5">
            ...
            <button className="h-8 w-8 sm:h-9 sm:w-9 rounded-xl bg-slate-50 text-slate-700 hover:bg-slate-100 flex items-center justify-center" aria-label="Abrir">
