...
export default function ParentsNavbar(): JSX.Element {
  ...
  return (
    <div className="sticky top-0 z-50">
      <nav className="w-full px-6 py-3 bg-white text-black shadow-sm">
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={onLogout}
            className="h-10 w-10 rounded-xl bg-rose-50 text-rose-600 flex items-center justify-center hover:bg-rose-100"
