    ...
    <div className="sticky top-0 z-50">
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-extrabold text-xl sm:text-2xl text-slate-800">
            Skoolia
          </span>
        </div>
        ...
        <div className="flex items-center gap-4 sm:gap-8">
          ...
          <div className="flex gap-3 sm:gap-5">
            <button
              ...
              className="px-3 sm:px-5 py-2 text-sm sm:text-base text-slate-800 rounded-full font-extrabold flex items-center gap-2 border-none hover:text-indigo-600 cursor-pointer focus:outline-none focus:ring-0"
            >
              <LogIn size={15} />
              ENTRAR
            </button>
            <button
              ...
              className="px-3 sm:px-5 py-2 rounded-2xl bg-slate-900 text-white text-sm sm:text-base font-bold flex items-center gap-2
